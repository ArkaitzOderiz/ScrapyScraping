...
\begin{lstlisting}[language=Python, caption={Combrobar limites de Chcantabrico Code Spider}]
...
\begin{lstlisting}[language=Python, caption={Selector Chcantabrico Coordinates Spider}]
...
\begin{lstlisting}[language=Python, caption={Selector MeteoNavarra Code Spider}]
...
\newline
Del selector se obtiene tanto el nombre como el código de la estación, siendo una lista de listas pues almacena estos datos por cada estación.
...
A la hora de guardar los datos, itera sobre lista y ... TODO
...
\begin{lstlisting}[language=Python, caption={Selector MeteoNavarra Data Spider}]
...
\begin{lstlisting}[language=Python, caption={Comprobacion exitencia de datos en MeteoNavarra Data Spider}]
	if datos:
		yield {
